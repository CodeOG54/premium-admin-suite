...
export const attendanceData: EmployeeAttendance[] = [
  {
    ...
    leaveRequests: [
      { id: "lr-1-1", date: "2025-07-22", reason: "Sick Leave", status: "Approved" },
      { id: "lr-1-2", date: "2024-12-01", reason: "Personal", status: "Pending" }
    ]
  },
  {
    employeeId: 2,
    ...
    leaveRequests: [
      { id: "lr-2-1", date: "2025-07-15", reason: "Family Responsibility", status: "Denied" },
      { id: "lr-2-2", date: "2024-12-02", reason: "Vacation", status: "Approved" }
    ]
  },
  {
    employeeId: 3,
    ...
    leaveRequests: [
      { id: "lr-3-1", date: "2025-07-10", reason: "Medical Appointment", status: "Approved" },
      { id: "lr-3-2", date: "2024-12-05", reason: "Personal", status: "Pending" }
    ]
  },
  {
    employeeId: 4,
    ...
    leaveRequests: [
      { id: "lr-4-1", date: "2025-07-20", reason: "Bereavement", status: "Approved" }
    ]
  },
  {
    employeeId: 5,
    ...
    leaveRequests: [
      { id: "lr-5-1", date: "2024-12-01", reason: "Childcare", status: "Pending" }
    ]
  },
  {
    employeeId: 6,
    ...
    leaveRequests: [
      { id: "lr-6-1", date: "2025-07-18", reason: "Sick Leave", status: "Approved" }
    ]
  },
  {
    employeeId: 7,
    ...
    leaveRequests: [
      { id: "lr-7-1", date: "2025-07-22", reason: "Vacation", status: "Pending" }
    ]
  },
  {
    employeeId: 8,
    ...
    leaveRequests: [
      { id: "lr-8-1", date: "2024-12-02", reason: "Medical Appointment", status: "Approved" }
    ]
  },
  {
    employeeId: 9,
    ...
    leaveRequests: [
      { id: "lr-9-1", date: "2025-07-19", reason: "Childcare", status: "Denied" }
    ]
  },
  {
    employeeId: 10,
    ...
    leaveRequests: [
      { id: "lr-10-1", date: "2024-12-03", reason: "Vacation", status: "Pending" }
    ]
  }
];
